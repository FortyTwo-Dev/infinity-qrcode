...
<template>
  <main class="w-full h-full flex flex-col gap-18 items-center justify-center">
          ...
          <ul class="flex flex-col gap-4 lg:overflow-scroll px-4">
            ...
            <li class="not-last:border-b-2 border-[#202020] py-2">
              ...
              <div class="w-full flex flex-row flex-wrap gap-2">
                ...
                <div class="inline-flex items-center not-dark:shadow dark:bg-[#202020] p-2 hover:opacity-85">
